...
// Helper function which, given the entire state's data structure, extracts the requested rate for the requested state
...
function renderMap(data, svg_id, val_range, rate_type) {
    ...
    /* -------------------------------------------------------------------------- */
    /*  On click, sub-function of RenderMap to set states and category             */
    /* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*        Function to draw initial line graphs                                 */
/* -------------------------------------------------------------------------- */
function updateGraphs(selectedStates, selectedCategory){
    ...
    //the enter selection; add svg canvas
    ...
    //Add the state name to the line chart
    g.append("text")
        .attr("class", "label")
        .attr("x", 250 / 2)
        .attr("dy", "1em")
    ...
    // Loop to draw line for each group
    ...
    /* -------------------------------------------------------------------------- */
    /*        Configure radio buttons to update the lines on click                */
    /* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/*        Re-draw lines upon radio button change                              */
/* -------------------------------------------------------------------------- */
